    ...
    return (
      ...
      */}
            <div>
                                                ...
                                                {navigation.map((item) => (
                                                    <li key={item.name}>
                                                        <NavLink
                                                            to={item.href}
                                                            className={({ isActive }) =>
                                                                classNames(isActive ? "bg-gray-800 text-white" : "text-gray-400 hover:text-white hover:bg-gray-800", 'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold')
                                                            }
                                                        >
                ...
                <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 hover:w-72 lg:overflow-y-auto lg:bg-gray-900 lg:pb-4 overflow-x-hidden transition-[width] duration-300"
                ...
                >
                    ...
                    <nav className="mt-8">
                        <ul role="list" className="flex-col items-center space-y-1 px-4">
                            {navigation.map((item) => (
                                <li key={item.name}>
                                    <NavLink
                                        to={item.href}
                                    ...
                                    >
                                        <item.icon className="h-6 w-6 shrink-0" aria-hidden="true" />
                                        <span className={showLabel ? '' : 'sr-only'}>{item.name}</span>
                                    </NavLink>
                                </li>
                            ))}
                        </ul>
